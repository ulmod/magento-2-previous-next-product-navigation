...
* Ability to previous, next product with a single click
* Ability to back to the category of the product with a single click
* Display the previous, next, and back buttons in a different position on the page
* Display previous, next, and back buttons in form of text or arrow
* Ability to sort prev/next products by position, price, product name, product id
* Ability to order prev/next products by ascending or descending
* Mobile-friendly
* Support multiple-stores


<img src="https://www.ulmod.com/media/ulmod/product_content/umprevnext-pn.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/umprevnext-back.png">
